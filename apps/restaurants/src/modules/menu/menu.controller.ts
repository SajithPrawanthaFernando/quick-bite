...
import { 
    ...
    UseGuards, Request, HttpStatus, Query, UnauthorizedException 
  } from '@nestjs/common';
  ...
  export class MenuController {
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Return menu item details' })
    ...
    @ApiResponse({ status: HttpStatus.CREATED, description: 'Menu item created successfully' })
    @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Invalid input' })
    @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Not authorized to add menu to this restaurant' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Menu item updated successfully' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Menu item not found' })
    @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Not authorized to update this menu item' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Menu item deleted successfully' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Menu item not found' })
    @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Not authorized to delete this menu item' })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'Menu item availability updated' })
    @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Menu item not found' })
    @ApiResponse({ status: HttpStatus.FORBIDDEN, description: 'Not authorized to update this menu item' })
